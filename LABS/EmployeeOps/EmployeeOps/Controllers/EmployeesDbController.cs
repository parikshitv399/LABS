...
namespace EmployeeOps.Controllers
{
    ...
    {
        private readonly EmployeeOpsContext _context;

        public EmployeesDbController(EmployeeOpsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employee>> PostEmployee(Employee employee)
        {
          if (_context.Employee == null)
          {
              return Problem("Entity set 'EmployeeOpsContext.Employee'  is null.");
          }
